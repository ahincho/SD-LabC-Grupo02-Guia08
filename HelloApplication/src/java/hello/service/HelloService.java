 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://endpoint.service.hello/", wsdlLocation = "http://localhost:8085/Hello/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://endpoint.service.hello/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8085/Hello/HelloService?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://endpoint.service.hello/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://endpoint.service.hello/", "HelloPort"), Hello.class, features);
    }
