...
import hello.service.deploy.Hello;
...
public class GreetingServlet extends HttpServlet {
     ...
     */
    // @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8085/HelloService2/HelloService.wsdl")
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<p><strong>Say Hello:</strong> " + sayHello("World") + "</p>");
            out.println("</body>");
            out.println("</html>");
        }
    }
